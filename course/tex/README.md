...
### 人に尋ねる
専門家に尋ねるのはとても効果的な調査方法です。先生、先輩、学会で会った人、いろんな人と研究の話をして、欲しい論文の情報を聞き出しましょう。稀に「人に尋ねる前に自分で調べろ」と言う主旨の発言をする意味不明な狂人が出現します。その場合は、「あなたという人間型デバイスを用いて今調べているところです。教えていただけませんでしょうか。」とできるだけ下から敬意を払って再度質問しましょう。質問に一切答えず、無関係な発言、例えば「ググる（Googleを用いて検索するの意味）とか辞書を引くとかその前にやるべきことがあるだろ」のように意味不明な発言を続けるようでしたら、「今回の調査にはこの人間型デバイスは役に立たないな」とし、「今回のような調査でのお役立ちデバイスランキングでGoogleや辞書より下に移動し」、別の人か手段を探しましょう。
### 検索エンジンを使う
論文検索エンジンとして、[Google Scholar](https://scholar.google.co.jp/schhp?hl=ja)、[CiNii](http://ci.nii.ac.jp/)が有名です。
