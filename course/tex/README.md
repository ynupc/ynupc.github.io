...
Overleaf上に執筆環境を構築します。下記の課題を１から６まで順にこなすことで、執筆環境が整います。早く終わった人は応用課題1、2をやってみてください。
...
**[課題3]** MS PowerPointを用いて次の指示に従い画像を作成してください。
作成した画像を作成したプロジェクトに貼り付けてください。  

* 必ず一回は分岐を含むようなflow chartを適当に作成してください。
* 図形のサイズ（高さ、幅）、位置（横位置、縦位置）などがずれていたら揃えてください。ずれていないかをチェックする意味でも必ずそれら４つの値（高さ、幅、横位置、縦位置）は調べてください。

### 表挿入

**[課題4]** 作成したプロジェクト内に次の指示に従い表を作成してください。 
